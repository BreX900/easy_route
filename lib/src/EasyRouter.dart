...
class EasyRouter {
  ...
  /// Open new Screen
  static Future<dynamic> push(BuildContext context, WidgetRoute screen,
      {PocketRouteOptions options}) async {
  ...
  static Future<Object> pushAndRemoveUntilRoute(
    ...
    return await pushAndRemoveUntil(context, screen, ModalRoute.withName(routeName),
        options: options);
  }
